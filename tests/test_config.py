...
def test_a_malformed_attachment_entry_is_refused_at_load(tmp_path: Path) -> None:
...
def test_attachment_keeps_the_order_it_was_written_in(tmp_path: Path) -> None:
    path = _write(
